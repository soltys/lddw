...
static char *argstream_next(ArgStream *stream) { return stream->args[stream->index++]; }

static bool argstream_has_next(ArgStream *stream) { return stream->index < stream->count; }
...
char *ap_get_helptext(ArgParser *parser) { return parser->helptext; }
...
char *ap_get_version(ArgParser *parser) { return parser->version; }

void ap_first_pos_arg_ends_option_parsing(ArgParser *parser) { parser->first_pos_arg_ends_option_parsing = true; }

void ap_all_args_as_pos_args(ArgParser *parser) { parser->all_args_as_pos_args = true; }
...
bool ap_has_args(ArgParser *parser) { return parser->positional_args->count > 0; }

// Returns the number of positional arguments.
int ap_count_args(ArgParser *parser) { return parser->positional_args->count; }

// Returns the positional argument at the specified index.
char *ap_get_arg_at_index(ArgParser *parser, int index) { return (char *)parser->positional_args->entries[index]; }
...
void ap_set_cmd_callback(ArgParser *cmd_parser, ap_callback_t cmd_callback) { cmd_parser->cmd_callback = cmd_callback; }

bool ap_found_cmd(ArgParser *parent_parser) { return parent_parser->cmd_name != NULL; }

char *ap_get_cmd_name(ArgParser *parent_parser) { return parent_parser->cmd_name; }

ArgParser *ap_get_cmd_parser(ArgParser *parent_parser) { return parent_parser->cmd_parser; }

int ap_get_cmd_exit_code(ArgParser *parent_parser) { return parent_parser->cmd_callback_exit_code; }

void ap_enable_help_command(ArgParser *parent_parser, bool enable) { parent_parser->enable_help_command = enable; }

ArgParser *ap_get_parent(ArgParser *parser) { return parser->parent; }
...
bool ap_had_memory_error(ArgParser *parser) { return parser->had_memory_error; }
...
char *ap_get_zeroth_root_arg(ArgParser *parser) { return parser->root_parser->zeroth_root_arg; }
